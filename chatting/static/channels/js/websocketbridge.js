...
window.onload = () =>
{
    try {
        ...
        if(mrc != '')
        {
            mainAppWindow.innerHTML = `<ul class="collection with-header"><li class="collection-item avatar"><a style="float: right;" href="/"><i class="material-icons prefix medium">clear</i></a><img src="https://www.gstatic.com/webp/gallery/1.png" alt="" class="circle"><h5 id="frndname" class="blue-text text-darken-4"></h5></li></ul><div id="msgwindow" class="card-panel" style="height: 370px; margin-bottom: 0; overflow: auto;"></div><div class=""><div class="row"><div class="input-field col s10" style="color: #0d47a1;"><textarea id="textarea1" class="materialize-textarea" name="message"></textarea><label style="color: #0d47a1" for="textarea1">Type a message</label></div><div class="col s1"><button  data-target="modal1" class="modal-trigger" style="background: none; color: inherit; border: none; padding: 0; font: inherit; cursor: pointer; outline: inherit;" ><i class="medium material-icons blue-text">child_care</i></button></div><div class="col s1"><button style="background: none; color: inherit; border: none; padding: 0; font: inherit; cursor: pointer; outline: inherit;" ><i id="msgsend" class="medium material-icons blue-text col s1">send</i></button></div></div></div>`
